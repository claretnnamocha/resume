...
<head>
  ...
  <title>Claret Nnamocha - Resume Website</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a href="https://zuri.team" class="navbar-brand"><img src="/assets/img/logo.png" alt="" /></a>
        </div>
          ...
          <div class="col-md-12 col-sm-12 text-center">
            <div class="contents">
              ...
              <p class="script-font wow fadeInUp" data-wow-delay="0.6s">
                The Bishop of Backend dioceses
              </p>
            ...
            <div class="about-profile">
              <ul class="admin-profile">
                <li>
                  ...
                  <span class="pro-detail">Claret Nnamocha</span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="pro-detail">Nigeria</span>
                </li>
                <li>
                  <span class="pro-title"> Location </span>
                  <span class="pro-detail">Owerri, Imo State</span>
                </li>
                <li>
                  <span class="pro-title"> e-mail </span>
                  <span class="pro-detail">devclareo@gmail.com</span>
                </li>
                <li>
                  <span class="pro-title"> Phone </span>
                  <span class="pro-detail">+ (234) 0903 411 6102</span>
                </li>
                <li>
          ...
          <div class="experience wow fadeInRight" data-wow-delay="0.6s">
            <ul class="timeline">
              ...
              <li>
                <div class="content-text">
                  <h3 class="line-title">
                    Senior Software Engineer - WAYA MultiLinks
                  </h3>
                  <span>Nov 2020 - May 2021</span>
                  <p class="line-text">
                    Working with a team of software developers to build APIs
                    for payment solutions<br />
                    Built modules with clean code architecture <br />
                    Managed a small team within the engineering team
                  </p>
                </div>
              </li>
              <li>
                <div class="content-text">
                  <h3 class="line-title">Backend Developer - JENSIV LTD</h3>
                  <span>Nov 2018 - Nov 2020</span>
                  <p class="line-text">
                    I worked in a team of software developers to build APIs
                    for a telemedicine service that uses the Django
                    framework.<br />
                    I created REST APIs for a literature-based application and
                    web app using the Django framework alongside two other
                    software developers. <br />
                    Create a multiplayer trivia mobile app
                  </p>
                </div>
              </li>
              <li>
                <div class="content-text">
                  <h3 class="line-title">
                    Intern Python Tutor - Aptech Computer Education
                  </h3>
                  <span>Oct 2018 - Jan 2019</span>
                  <p class="line-text">
                    I taught a class the python programming language from
                    essential to intermediate level.<br />
                    I built several python applications as tools for learning
                    the Python programming language.<br />
                    Created a curriculum used in the learning process
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div class="row contact-form-area wow fadeInUp" data-wow-delay="0.4s">
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="contact-block">
              <h2 id="contact-us">Contact Form</h2>
              <form id="contactForm">
                <div class="row">
                  <div class="col-md-6">
            ...
            <div class="footer-right-area wow fadeIn">
              ...
              <div class="footer-right-contact">
                ...
                <div class="single-contact">
                  ...
                  <p><a href="mailto:devclareo@gmail.com">devclareo@gmail.com</a></p>
                  <p>
                    <a href="mailto:tomsaulnier@gmail.com">hello@claretnnamocha.com</a>
                  </p>
                </div>
                <div class="single-contact">
                  <div class="contact-icon">
                  ...
                  <p><a href="#">+ (234) 0903 411 6102</a></p>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="footer-text text-center wow fadeInDown" data-wow-delay="0.3s">
            ...
            <p>Copyright &copy; 2018 UIdeck All Right Reserved</p>
          </div>
        </div>
      </div>
    </div>
